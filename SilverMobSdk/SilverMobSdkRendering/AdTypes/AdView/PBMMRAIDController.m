...
#import "SilverMobSdkSwiftHeaders.h"
#if __has_include("SilverMobSdk-Swift.h")
#import "SilverMobSdk-Swift.h"
#else
#import <SilverMobSdk/SilverMobSdk-Swift.h>
#endif
...
// Attempt to present <UIAlertController: 0x7fb49c013a00> on <SilverMobSdkDemoRendering.BannerViewController: 0x7fb499c52f30> whose view is not in the window hierarchy!
