...
//Note: SilverMobSdk supports only Interstitial right now
...
//2) Progressive
//3) Download
//Note: SilverMobSdk supports Streaming and Download.
...
//6) Sidebar
//7) Full Screen
//Note: SilverMobSdk supports Full Screen Only
...
//4 ORMMA
//5 MRAID-2
//Note: SilverMobSdk doesn't yet support Companion ads, so no apis are supported.
